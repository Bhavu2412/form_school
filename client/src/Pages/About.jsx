    ...
    <>
      <div className="flex flex-col items-center justify-center w-screen space-y-10 mt-8">
        <div clasName="flex flex-col items-center justify-center">
          ...
          <h1 className="font-hTags">About FormsPro</h1>
        </div>
        <p className="w-[71vw] text-md font-General">
      ...
      <div className="flex flex-col items-center space-y-5 justify-center m-8 p-2 w-70vw rounded-lg">
        <img
